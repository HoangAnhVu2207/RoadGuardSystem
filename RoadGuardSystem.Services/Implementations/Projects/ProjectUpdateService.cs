...
{
    private readonly IProjectUpdateRepository _persistence;

    public ProjectUpdateService(IProjectUpdateRepository persistence)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (command.EngineeringUtmSrid is int srid && !SpatialConstants.IsAllowedProjectUtmSrid(srid))
        {
            return new(ProjectUpdateStatus.InvalidInput);
        }
