...
| `P1-20` | `In Progress` | `anh` | Create Project with primary PM/handover, update metadata, create Warranty, and the assign/reassign-primary-PM implementation are present on `anh`. API/SQL verification remains assigned to Huy before this parent task can become Done. |
