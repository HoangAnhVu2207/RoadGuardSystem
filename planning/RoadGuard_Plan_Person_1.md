...
| `P1-20` | `In Progress` | `anh` | Completed slices: create Project with primary PM/handover, update mutable Project metadata, and create Warranty with audit/idempotency. Remaining before parent completion: assign/reassign primary PM with stale-write and exactly-one-active-primary enforcement. |
