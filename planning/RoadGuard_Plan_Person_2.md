...
| `P2-08` | `Ready for review` | `huy` | Owner-requested local SQL Server, Docker Compose and Testcontainers setup guide for Huy. Guide, worklog and applicable checks are complete; runtime installation on Huy's machine and separate Codex acceptance remain. Exclusive paths: `docs/setup/sql-server-docker-local-setup.md`, `docs/worklogs/P2-08-completion.md`, and this plan's P2-08 entries. Documentation only; P2-00/P2-01 accepted artifacts remain unchanged. |
